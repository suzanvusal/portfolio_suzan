...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* IMAGE */}
      <div data-blobity-tooltip="DevOps Engineer">
        <motion.div
          ref={imgRef}
          style={{ rotate }}
          initial={{ opacity: 0 }}
        ...
        >
          {/* Glow ring */}
          <div className="absolute inset-0 rounded-full blur-2xl bg-gradient-to-br from-[#7CC0C4]/40 via-[#548FBA]/40 to-[#3C84C7]/40" />

          {/* Image container */}
            <div className="relative w-[280px] h-[280px] xl:w-[340px] xl:h-[340px] rounded-full overflow-hidden">
          <Image
            src="/sujhero.png"
            priority
            fill
